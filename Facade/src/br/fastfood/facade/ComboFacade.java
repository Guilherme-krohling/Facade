...
public class ComboFacade {
   private Combo combo;
    ...
    public void criarCombo(int escolha){
        switch (escolha) {
            case 1:
                ItemCombo burguer = new Burger("McChicken", 15);
                ItemCombo bebida = new Bebida("guarana", 5);
                ItemCombo sobremesa = new Sobremesa("sorvete", 7);
                combo = new Combo(burguer, bebida, sobremesa);
                break;
            case 2:
                ItemCombo burger2 = new Burger("Big King", 17);
                ItemCombo bebida2 = new Bebida("Coca", 6);
                ItemCombo sobremesa2 = new Sobremesa("casquinha", 3);
